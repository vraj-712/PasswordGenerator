...
const App = () => {
  ...
  return (
    <div className="h-screen w-full bg-gray-400">
      <div className="md:w-4/5 md:h-3/4 h-screen w-screen bg-indigo-500 p-4 top-1/2 left-1/2 absolute transform -translate-x-1/2 -translate-y-1/2 rounded-xl">
        <div className="h-full w-full bg-indigo-200 rounded-xl p-2 flex flex-col gap-2">
          ...
          <div className="bg-indigo-500 md:p-5 p-3 rounded-xl h-full flex flex-col md:gap-5 gap-2 justify-evenly">
            ...
            <div className="flex flex-row mx-auto md:w-3/4 w-full ">
            ...
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 md:w-11/12 w-full mx-auto ">
